...
function gridization(){
    ...
    //         vecField[cell.r][cell.c].vec = {x:x, z:z};
    //     }
    // }
    ...
    // availableVecField.forEach(function (item, index){
...
function animate() {
    ...
    PHY.step(RADIUS, agentData, pickableWall, world, WORLDUNIT, plannerMode, exits);
    // const frameNumber = parseInt(document.getElementById('frame').value);
...
//         let distance = Math.sqrt(Math.pow(A[0] - pointsArray[i][0], 2) + Math.pow(A[1] - pointsArray[i][1], 2));
//
